...
<body>
	...
	<table class="table-content" style="font-size:17px; width:100%; margin-bottom:5px; border-right:0px">
		<tr>
	...
	<table class="table-content" style="font-size:17px; width:100%; border:1px solid black; margin-bottom:5px; border-right:0px">
		<tr>
