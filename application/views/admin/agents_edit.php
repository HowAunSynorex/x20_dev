                ...
                <div class="col-6 my-auto text-right">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item text-danger" href="javascript:;" onclick="del_agent_ask(<?php echo $result['pid']; ?>)">Delete</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 text-">Username</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="fullname" placeholder="Full Name" value="<?php echo $result['fullname']; ?>" required>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <div class="col-md-9 offset-md-3">
                                ...
                                <a href="<?php echo base_url('admin/agents_list'); ?>" class="btn btn-link text-muted">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
