					...
					<tbody> 
						...
						foreach($teacher as $t) {
							...
							<tr>
								<td><?php echo $i; ?></td>
								<td>
									<a href="<?php echo base_url('teachers/edit/'.$t['pid']); ?>">
										<?php echo ($t['fullname_cn'] !="")?$t['fullname_cn']:$t['fullname_en']; ?>
									</a>
									<?php 
									
									$join_date = datalist_Table('tbl_users', 'date_join', $t['pid']);
									...
									for($j=1; $j<=$days_in_month; $j++) {
										...
										foreach($result as $e) {
											...
											if($e['user'] == $t['pid']){
												...
												// check whether teacher check in at that day
