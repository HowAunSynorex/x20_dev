            ...
            <table class="table-hover table">
                <thead>
                    ...
                    <th style="width:10%">
                        ...
                        ?>
                        <a href="<?php echo base_url('reports/outstanding_payment?sort='.$sort.'&q='.$name.'&age='.$age); ?>" class="float-right sort-link"><i class="fa fa-fw fa-sort-alpha-<?php echo $_GET['sort'] == 'asc' ? 'down' : 'up'; ?>"></i></a>
                    </th>
                    <th style="width:25%">
						Student
                ...
                <tfoot>
					<tr>
						<th colspan="3" class="text-right">Total Outstanding Payment</th>
						<th></th>
						<th></th>
						<th></th>
						<th class="text-right">
							<input type="hidden" name="total_outstanding" value="0">
							<span id="total_outstanding"></span>
							<?php //echo number_format($total, 2, '.', ','); ?>
						</th>
						<th></th>
					</tr>
					<tr>
						<th colspan="3" class="text-right">Total Outstanding Student(s)</th>
						<th></th>
						<th></th>
						<th></th>
						<th class="text-right">
							<input type="hidden" name="total_outstanding_std" value="0">
							<input type="hidden" name="page" value="0">
							<input type="hidden" name="branch" value="<?php echo branch_now('pid'); ?>">
							<span id="total_outstanding_std"></span>
