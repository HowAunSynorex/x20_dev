            ...
            <table class="DTable table">
                ...
                <tbody>
					...
					$i=0; foreach($result as $e) { 
						if(datalist_Table('tbl_users', 'branch', $e['user']) == branch_now('pid')) {
							$i++;
							?>
							<tr>
								<td><?php echo $i; ?></td>
								<td><?php echo datalist_Table('tbl_users', 'fullname_en', $e['user']); ?></td>
								<td><?php echo $e['amount_1']; ?></td>
								<td><?php echo $e['amount_0']; ?></td>
								<td><?php $total[$e['user']] += ($e['amount_1'] - $e['amount_0']); echo $total[$e['user']];?>
								</td>
							</tr>
							<?php
						}
