											...
											for($j=1; $j<=$days_in_month; $j++) {
												...
												foreach($result2 as $e2){
													...
													if($e2 == $j) {
														...
														$query = $this->log_join_model->list('class_attendance', branch_now('pid'), [
														...
														if(count($query) > 0) {
															...
															id="<?php echo $e['user']."-".$year."-".$month."-".$e2."_".$id; ?>"
															checked
															>
															<?php
															...
															type="checkbox"
															name="attendance[]"
															id="<?php echo $e['user']."-".$year."-".$month."-".$e2; ?>"
															value="<?php echo $e['user'].','.$year."-".$month."-".$e2; ?>"
															>
															<?php
