		...
		<div class="card">
			<div class="card-header text-center p-4" style="background: #28a745 linear-gradient(180deg,#48b461,#28a745) repeat-x!important;">
				<div class="p-4">
					...
					<h5 class="text-white font-weight-bold pt-4">Check <?php echo ucfirst($_GET['check']); ?> Succcessfully</h5>
				</div>
			</div>
			<div class="card-body p-4 d-flex flex-column align-items-center">
				<p class="m-0">You have been checked <?php echo $_GET['check']; ?> on <span class="font-weight-bold"><?php echo date('Y-m-d H:i:s'); ?></span>.</p>
			</div>
		</div>
