        ...
        <div class="container-fluid container-wrapper">
            ...
            <form id="main-form" method="post" onsubmit="Loading(1)">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control select2"
                                        ...
                                        <?php foreach ($student as $e) { ?>
                                            ...
                                            } ?>><?php echo datalist_Table('tbl_users', 'fullname_cn', $e['user']) . datalist_Table('tbl_users', 'fullname_en', $e['user']) . '(' . datalist_Table('tbl_users', 'code', $e['user']) . ')'; ?></option>
                                        <?php } ?>
                                    </select>
                                    <?php if (empty($id)) { ?>
                                ...
                                <div class="col-md-9">
                                    <select class="form-control select2"
                                        ...
                                        <?php foreach ($student as $e) { ?>
                                            ...
                                            } ?>><?php echo $e['fullname_cn'] .' '. $e['fullname_en'] . ' (' . $e['code'] . ')' . ' (' . $e['pid'] . ')'; ?></option>
                                        <?php } ?>
                                    </select>
                                    <?php if (empty($id)) { ?>
                                        <div class="alert alert-warning mt-2">Please select a student</div>
                ...
                if (isset($id) && !empty($id))
                {
					...
					if (isset($_GET['next']))
					{
						$std_unpaid_result = std_unpaid_result2($id, '', '', 'Y');
                        ...
                        foreach ($std_default_result['result']['default_class'] as $e)
                        {
                           ...
                           // print_array($default_class_bunlde);
                            if (count($default_class_bunlde) > 0)
                            {
                                ...
                                $parent_id = $default_class_bunlde['parent'];
                            }
                            else
                            {
						 ...
						 // echo "<pre>";
						 // print_r($with_default_class_bundle);
						 // echo "</pre>";
					

                        $class_bundle_price_list = $this->log_join_model->list('class_bundle_price', branch_now('pid'), [
                            'parent' => $parent_id,
                        ]);
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <script>
                                var class_bundle_price_list = <?php echo json_encode($class_bundle_price_list); ?>
                            </script>
                            ...
                            <table class="table table-bordered">
                                ...
                                foreach ($new_default_unpaid_class as $k => $e)
                                {
                                    ...
                                    {	
                                        ...
                                        $total_default_fee += (isset($e2['amount']) ? ((float)$e2['amount']) : 0);
                                        $total_default_discount += (isset($e2['discount']) ? ((float)$e2['discount']) : 0);
                                ...
                                */
                                ...
                                <tr>
                                    ...
                                    <!-- there is no exist passing value $total_default_fee2 -->
                                    <!-- <td class="text-right"><?php echo number_format($total_default_fee2+$total_default_fee, 2, '.', ',');; ?></td> -->
                                    <td class="text-right"><?php echo number_format($total_default_fee, 2, '.', ','); ?></td>
                                </tr>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Tan Jing Suan -->
                            <?php 
                                $autosave = $this->log_join_model->list(
                                'auto_save_payment', 
                                branch_now('pid'), 
                                [
                                    'user' => $id
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="date" class="form-control" name="date"
                                        onchange="autosave_edit(
                                        <?=$id; ?>,
                                        'payment_date',
                                        this.value)"
                                        value="<?php 
                                            if ( count($autosave) > 0 ) {
                                                echo $autosave[0]['payment_date'];
                                            } else {
                                                echo date('Y-m-d');
                                            }
                                        ?>" required>  
                                ...
                                <div class="col-md-9">
                                    ...
                                    this.value)"
                                        ...
                                        } ?><?php foreach ($subsidy_fee as $k => $v)
                                        {
                                            ...
                                            if ( count($autosave) > 0 ) {
                                                echo $autosave[0]['payment_remark'];
                                            }
                                    ?></textarea>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    ...
                                    >
                                        <?php foreach ($payment_now as $e) { ?>
                                            ...
                                            <?= isset($autosave[0]['payment_method']) && 
                                            $e['pid'] === $autosave[0]['payment_method'] ? 'selected' : '' ?>

                                            ><?php echo $e['title']; ?></option>
                                        <?php } ?>
                                        <?php foreach ($payment_all as $e) { ?>
                                            <option value="<?php echo $e['secondary']; ?>"

                                            <?= isset($autosave[0]['payment_method']) && 
                                            $e['secondary'] === $autosave[0]['payment_method'] ? 'selected' : '' ?>

                                            ><?php echo datalist_Table('tbl_secondary', 'title', $e['secondary']); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    if (isset($e2['amount']))
                                    {
                                        ...
                                        <tr class="item<?php echo $i; ?>">
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" class="class_type" name="item[<?php echo $i; ?>][type]" value="class">
                                                ...
                                                <textarea class="form-control mt-2" onclick="this.select();"
                                                        ...
                                                        'remark',
                                                        this.value)"
                                                        name="item[<?php echo $i; ?>][remark]" rows="1"><?php echo $e2['remark']; ?></textarea>
                                                <div class="mt-2">
                                                    <!-- Tan Jing Suan -->
                                                    <!-- <a href="javascript:;" onclick="row_del(<?php echo $i; ?>)"
                                                       class="text-danger"><i class="fa fa-fw fa-trash"></i> Remove</a> -->
                                                    <a href="javascript:;" onclick="item_del(<?php echo $i.",".$e2['id']; ?>)"
                                                       class="text-danger"><i class="fa fa-fw fa-trash"></i> Remove</a>
                                                </div>
                                            </td>
                                            ...
                                            <!-- Tan Jing Suan -->
                                            <?php 
                                                $log_join = $this->log_join_model->view($e2['id']);
                                                if (count($log_join) > 0 ) {
                                                    $totalamount = $log_join[0]['amount'];
                                                    $amount_unit = $log_join[0]['amount_unit'];
                                                }
                                            ?>
                                            <td><input type="number" step="0.01" onclick="this.select();"
                                                       ...
                                                       class="input-remove_arrow form-control text-right"
                                                       value="<?php 
                                                            if (isset($amount_unit)) {
                                                                echo number_format($amount_unit, 2, '.', '');
                                                            } else {
                                                                echo number_format($e2['amount'], 2, '.', '');
                                                            }
                                                       ?>"
                                                       required></td>
                                            <td><input type="number" step="0.01" onclick="this.select();"
                                    ...
                                    <tr class="item<?php echo $i; ?>">
                                        ...
                                        <td>
                                            ...
                                            <textarea class="form-control mt-2" onclick="this.select();"
                                                    ...
                                                    'remark',
                                                    this.value)"
                                                    name="item[<?php echo $i; ?>][remark]" rows="1"><?php echo $e['data']['remark']; ?></textarea>
                                            <div class="mt-2">
                                                <!-- Tan Jing Suan -->
                                                <!-- <a href="javascript:;" onclick="row_del(<?php echo $i; ?>)"
                                                   class="text-danger"><i class="fa fa-fw fa-trash"></i> Remove</a> -->
                                                <a href="javascript:;" onclick="item_del(<?php echo $i.",".$e['data']['id']; ?>)"
                                                   class="text-danger"><i class="fa fa-fw fa-trash"></i> Remove</a>
                                            </div>
                                        </td>
                                        <td><input type="number" onclick="this.select();"
                                        ...
                                        <!-- Tan Jing Suan -->
                                        <?php 
                                            $log_join = $this->log_join_model->view($e['data']['id']);
                                            if (count($log_join) > 0 ) {
                                                $totalamount = $log_join[0]['amount'];
                                                $amount_unit = $log_join[0]['amount_unit'];
                                            }
                                        ...
                                        <td><input type="number" step="0.01" onclick="this.select();"
                                                   ...
                                                   value="<?php
                                                        if (isset($amount_unit)) {
                                                            ...
                                                            echo number_format($e['data']['amount'], 2, '.', '');
                                                        }
                                                   ?>"
                                                   required></td>
                                        <td><input type="number" step="0.01" onclick="this.select();"
                                ...
                                <tr class="item<?php echo $i; ?>">
                                    ...
                                    <td>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <!-- <a href="javascript:;" onclick="row_del(<?php echo $i; ?>)"
                                               class="text-danger"><i class="fa fa-fw fa-trash"></i> Remove</a> -->
                                            <a href="javascript:;" onclick="item_del(<?php echo $i.",".$e['id']; ?>)"
                                               class="text-danger"><i class="fa fa-fw fa-trash"></i> Remove</a>
                                        </div>
                                    </td>
                                    <td><input type="number" onclick="this.select();"
                                    ...
                                    <!-- Tan Jing Suan -->
                                    <?php 
                                        $log_join = $this->log_join_model->view($e['id']);
                                        if (count($log_join) > 0 ) {
                                            $totalamount = $log_join[0]['amount'];
                                            $amount_unit = $log_join[0]['amount_unit'];
                                        }
                                    ...
                                    <td><input type="number" step="0.01" onclick="this.select();"
                                               ...
                                               value="<?php
                                                    if (isset($amount_unit)) {
                                                        ...
                                                        echo number_format(datalist_Table('tbl_inventory', 'price_sale', $e['item']), 2, '.', '');
                                                    }
                                               ?>"
                                               required></td>
                                    <td><input type="number" step="0.01" onclick="this.select();"
                                               ...
                                               value="<?php 
                                                    if (isset($totalamount)) {
                                                        if ( strval($totalamount) !== "0" ) {
                                                            ...
                                                            echo number_format(datalist_Table('tbl_inventory', 'price_sale', $e['item']) * $e['qty'], 2, '.', '');
                                                        }
                                                    } else {
                                                        echo number_format(datalist_Table('tbl_inventory', 'price_sale', $e['item']) * $e['qty'], 2, '.', '');
                                                    }
                                ...
                                <tr class="item<?php echo $i; ?>">
                                    ...
                                    <td>
                                        ...
                                        <textarea class="form-control mt-2" onclick="this.select();"
                                                ...
                                                'remark',
                                                this.value)"
                                                name="item[<?php echo $i; ?>][remark]" rows="1"><?php echo $e['remark']; ?></textarea>
                                        <div class="mt-2">
                                            <!-- Tan Jing Suan -->
                                            <!-- <a href="javascript:;" onclick="row_del(<?php echo $i; ?>)"
                                               class="text-danger"><i class="fa fa-fw fa-trash"></i> Remove</a> -->
                    ...
                    <div class="row">
                        <div class="col-md-12 text-left">
							<a class="btn btn-primary" href="<?php echo base_url('payment/add/'.$id.'?next=1'); ?>">Add next month</a>
							<a class="btn btn-secondary" href="<?php echo base_url($thispage['group'] . '/list'); ?>">Cancel</a>
							<!--<button type="submit" name="save_draft" class="btn btn-primary">Save as Draft</button>-->
							<button type="submit" style="float:right;" name="save" class="btn btn-primary">Make Payment</button>
						</div>
                    </div>
