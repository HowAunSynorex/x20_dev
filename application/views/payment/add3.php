                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control select2" onchange="window.location.href='<?php echo base_url('payment/add/'); ?>'+this.value" name="student" required>
                                    <option value="">-</option>
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							foreach($item_cat as $e) {
								$items[$e['title']][] = $this->tbl_inventory_model->list(branch_now('pid'), 'item', ['active' => 1, 'category' => $e['pid']]);
							}
							?>
							<tr id="<?php echo $id; ?>">
								<td>
